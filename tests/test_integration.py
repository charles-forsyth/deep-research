...
import pytest
import sys
from deepresearch import main, DeepResearchAgent


@pytest.fixture
def mock_agent_class():
    with patch("deepresearch.DeepResearchAgent") as mock_agent_cls:
...
@patch("deepresearch.SessionManager")
...
@patch("deepresearch.detach_process")
@patch("deepresearch.SessionManager")
