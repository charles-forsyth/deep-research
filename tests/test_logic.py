...
import pytest
import os
from deepresearch import FileManager, DeepResearchAgent, ResearchRequest
...
def test_recursive_research():
    with (
        ...
        patch("deepresearch.DeepResearchAgent.start_research_poll") as mock_poll,
        patch("deepresearch.DeepResearchAgent.start_research_stream") as mock_stream,
        patch("deepresearch.DeepResearchAgent.analyze_gaps") as mock_gaps,
        patch("deepresearch.DeepResearchAgent.synthesize_findings") as mock_synth,
        patch("deepresearch.SessionManager.create_session") as mock_create_session,
        patch("deepresearch.SessionManager.get_session") as mock_get_session,
        patch("deepresearch.SessionManager.update_session"),
    ):
        # Setup mocks
