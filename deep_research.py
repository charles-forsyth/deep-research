...
class SessionManager:
    ...
    def _init_db(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            # Bolt ⚡: Add indexes for faster session lookups.
            # As the session history grows, querying by these fields without an index
            # would result in a full table scan, making lookups slow.
